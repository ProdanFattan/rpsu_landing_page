    ...
    <>
      <div className="md:pt-32 pt-6">
        <div className="bg-section_back rounded-lg container mx-auto px-4 py-6 md:py-10">
          ...
          <section className="pt-4 md:pl-8">
            <h2 className="font-raleway font-semibold md:text-[24px] text-[18px] text-gray-800">
              Philanthropy
            </h2>
            <div className="mt-2 font-open_sans text-[12px] md:text-[14px] text-gray-600">
          ...
          <section className="pt-4 md:pl-8">
            ...
            <div className="mt-2 font-open_sans text-[12px] md:text-[14px] text-footer_back">
                <ul>
                    <li><a href="https://www.aljazeera.com/features/2021/12/16/1971-bangladesh-none-of-them-returned">‘1971 Bangladesh: ‘None of them returned’, Al-Jazeera,</a></li>
                    <li><a href="https://youtu.be/Efpqa80pqJ0?si=qDHAAga7RWXfY33l">'Short Documentary on Ranada Prasad Shaha', Youtube,</a></li>
                    <li><a href="https://www.finevector.com/2023/11/ranada-prasad-shaha-rp-shaha.html">'Philanthropist RP Shaha'</a></li>
                </ul>
